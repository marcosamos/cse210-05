...
### could be using sub classes and polymorphism to change what the directions are for player 1 and 2
...
class KeyboardService:
    ...
    def __init__(self):
        ...
        self._keys['w'] = pyray.KEY_W # set for player 1
        self._keys['a'] = pyray.KEY_A #
        self._keys['s'] = pyray.KEY_S #
        self._keys['d'] = pyray.KEY_D #

        self._keys['i'] = pyray.KEY_I #set for player two
